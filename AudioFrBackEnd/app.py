...
# Disable GPU to prevent CUDA errors on Render
os.environ["CUDA_VISIBLE_DEVICES"] = "-1"

# Initialize Flask app
app = Flask(__name__)
CORS(app, resources={r"/*": {"origins": "https://audio-fr.vercel.app"}})
...
model_path = 'TESTSETAaudio_classifier.keras'  # Ensure the model is in the correct path
